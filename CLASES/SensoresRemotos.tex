...
\titlepage
\centering
	\includegraphics[width=5cm]{G:/My Drive/FIGURAS/unal}\hspace*{4.75cm}~%
   	\includegraphics[width=2cm]{G:/My Drive/FIGURAS/logo3} 
\end{frame}
 %#############################SLIDE
\begin{frame}
...
\tiny{Fuente: ITC} 
  \begin{figure}
    \centering
    \includegraphics[height=.6\textheight]{G:/My Drive/CATEDRA/ANALISIS GEOESPACIAL/fig/definicion}
   \end{figure}
\end{frame}
%###############################SLIDE
\begin{frame}
